...
<doctype html>
    ...
    <body>
        ...
        $sql = "SELECT * FROM barang_masuk WHERE nama_barang LIKE '%$q%' ORDER BY nama_barang"; // query silahkan disesuaikan
        ...
        <div>
                                ...
                                <tr class="tr">
                                    ...
                                    <td width="150px" class="text-center">
                                        <div class="btn-group btn-group-justified">
                                            <a href=cetak_barcode.php?data=<?php echo $data['no_trx']; ?>><button type="button" class="btn btn-default"> <span class="glyphicon glyphicon-barcode"></span></button></a>
                                            <a href=mutakhir_barang_masuk.php?data=<?php echo $data['no_trx']; ?>><button type="button" class="btn btn-info"> <span class="glyphicon glyphicon-pencil"></span></button></a>
                                            <a href=hapus_barang_masuk.php?data=<?php echo $data['no_trx']; ?>><button type="button" class="btn btn-danger" onClick="return confirm('Apakah anda akan menghapus barang ini?');"><span class="glyphicon glyphicon-trash"></span></button></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href=form_barang_masuk.php> <input class="btn btn-primary" type=button value="+ Tambah Barang Masuk"></a>
                </div>
            </div>
        </div> <!-- container -->
    </body>
